...
**项目职责：**
1. 负责用户研究和需求分析，深入了解用户在使用自助服务终端时的痛点。
2. 设计并实施了一系列交互优化措施，包括界面简化、流程优化和智能化引导。
3. 协调跨部门团队合作，包括研发、产品、设计和运营团队，确保项目顺利推进。

**项目成果：**
1. 通过扫描二维码，预留短信提醒手机号，自助服务终端的用户满意度提高了40%，根据用户反馈调查显示操作更加直观易懂。
2.通过屏幕动画、语音提示和优化引导，减少了医院10%的耗材重复打印。
3. 优化后的交互流程帮助用户更加轻松地获取所需服务，显著提升了用户对医院服务的整体满意度。
## 教育背景
